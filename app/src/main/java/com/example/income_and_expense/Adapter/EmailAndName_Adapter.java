...
public class EmailAndName_Adapter extends ArrayAdapter {
    ...
    public EmailAndName_Adapter(@NonNull Context context, List<Income_Expense_Model> inc_exp_model, SQLiteDatabase db, String userEmail) {
...
//        }
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.emailandname_layout, parent, false);

//        LayoutInflater layoutInflater = LayoutInflater.from(con);
//        View view = layoutInflater.inflate(res, null);

        TextView name = convertView.findViewById(R.id.name_home_activity);
        TextView email = convertView.findViewById(R.id.email_home_activity);
